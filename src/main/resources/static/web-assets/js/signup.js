...
function onPasswordBlur(e) {
    activeElement = null;
    setTimeout(function () {
        if (activeElement == "toggle" || activeElement == "password" || activeElement == "confirmPassword") {
        } else {
            uncoverEyes();
        }
    }, 100);
...
function onPasswordToggleBlur(e) {
    ...
    if (!showPasswordClicked) {
        setTimeout(function () {
            if (activeElement == "password" || activeElement == "toggle" || activeElement == "confirmPassword") {
            } else {
                uncoverEyes();
            }
        }, 100);
